                ...
                <div className="bg-[var(--color-landing-backdrop)] rounded-lg p-8">
                  ...
                  <div className="flex items-center gap-2 mb-8 justify-center lg:justify-start">
                    ...
                    >
                      ...
                      <span className="text-sm font-mono" style={{ color: 'var(--color-accent-text)' }}>
                        OPEN SOURCE
                      </span>
                    </div>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm mb-4">
              <a 
                href="https://github.com/Yavnik/commandops"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-accent-text transition-colors"
                style={{ color: 'var(--color-secondary-text)' }}
              >
                ...
                <span className="font-mono">Open Source on GitHub</span>
              </a>
              <span style={{ color: 'var(--color-secondary-text)' }}>•</span>
              <a 
                href="https://github.com/Yavnik/commandops/blob/main/LICENSE"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-accent-text transition-colors font-mono"
                style={{ color: 'var(--color-secondary-text)' }}
              >
                MIT License
              </a>
